...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [GRAPHITE] = LAYOUT_moonlander(
        ...
        LT(6,KC_QUOTE),   HM_I,          HM_E,            KC_A,           HM_H,           KC_Y,           ______,             ______,           KC_G,       HM_S,           KC_T,           HM_R,           HM_N,           LT(6,KC_COMMA),
            ...
            KC_LCTL,      KC_RIGHT,      KC_DOWN,         MY_LEFT,        MY_UP,          LT(6,KC_LCTL),                                  LT(6,KC_ESCAPE),  MY_DOWN,        MY_RIGHT,       KC_SCLN,        KC_SCLN,        KC_RCTL,
                                                       LT(7, KC_NO),   KC_BSPC,        US_MAG1,                                             KC_DEL,     HM_SCLN,        LT(7, KC_SPACE)
            ),
    ...
    [FUNCTION] = LAYOUT_moonlander(
            ...
            ______,       KC_HASH,        KC_LEFT,        KEYDN,          KC_RIGHT,       KC_GRAVE,       TO(5),              TO(3),            KC_DOWN,    KC_4,           KC_5,           KC_6,           KC_KP_PLUS,     ______,
            ______,       KC_PERC,        KC_CIRC,        KC_LBRC,        KC_RBRC,        KC_TILD,                                              KC_AMPR,    KC_1,           KC_2,           KC_3,           KC_BSLS,        ______,
            SBIT,         KC_COMMA,       KC_VOLD,        KC_VOLU,        KC_AUDIO_MUTE,  ______,                                               ______,     KC_0,           KC_DOT,         KC_COMMA,       ______,         QK_BOOT,
                                                          KC_INS,         KC_DEL,         RGB_SLD,                                              PWM,        PWM2,           KEYUP
            ),
    ...
    [SYMBOLS] = LAYOUT_moonlander(
            KC_GRAVE,     KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_EQUAL,            KC_MINUS,          KC_6,       KC_7,           KC_8,           KC_9,           KC_0,           KC_ESCAPE,
            ______,       KC_BSLS,        KC_LBRC,        KC_RBRC,        KC_AT,          KC_PIPE,        ______,              ______,            KC_UNDS,    KC_PIPE,        KC_MINUS,       KC_AMPR,        KC_ASTR,        KC_F12,
            KC_DQUO,      KC_MINUS,       KC_LPRN,        KC_RPRN,        KC_HASH,        KC_ASTR,        ______,              ______,            KC_ASTR,    KC_UNDS,        KC_COMMA,       KC_DOT,         KC_KP_PLUS,     ______,
