...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [SEMIMAK] = LAYOUT_moonlander(
      ...
      LT(_F_, KC_F),      KC_S,          KC_R,            KC_N,           KC_T,           KC_K,           KC_EQUAL,           KC_MINUS,         KC_C,       KC_D,           KC_E,           KC_A,           KC_I,           LT(_F_, KC_Y),
            KC_LSFT,      KC_P,          KC_J,            KC_B,           KC_M,           KC_Q,                                                 KC_X,       KC_G,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_RSFT,
            KC_LCTL,      KC_RIGHT,      KC_DOWN,         MY_LEFT,        MY_UP,      LT(_F_,KC_ESC),                                      LT(_F_,KC_ESC),  MY_DOWN,        MY_RIGHT,       KC_SCLN,        KC_SCLN,        KC_RCTL,
                                                          MY_MAGIC,  LT(_S_, KC_SCLN),    KC_ENTER,                                             KC_DEL,     KC_LSFT,    LT(_S_, KC_SPACE)
            ),
    [GAMES] = LAYOUT_moonlander(
          ...
          LT(_F_,KC_Z),   KC_LSFT,        KC_A,           KC_S,           KC_D,           KC_F,           KC_G,               ______,           KC_H,       KC_J,           KC_K,           KC_L,           KC_QUOTE,       KC_QUES,
    ...
    [MAPLE] = LAYOUT_moonlander(
      ...
      LT(_F_,KC_DOT),     KC_LSFT,       KC_LEFT,         KC_DOWN,        KC_RIGHT,       KC_L,           KC_H,               ______,           KC_J,       KC_A,           MP_S,           KC_D,           KC_F,           KC_ENTER,
    ...
    [BMAGE] = LAYOUT_moonlander(
      ...
      LT(_F_,KC_DOT),     KC_LSFT,       KC_LEFT,         KC_DOWN,        KC_RIGHT,       KC_L,           KC_H,               ______,           KC_J,       B_A,            KC_S,           B_D,            KC_F,           LT(_F_, KC_ENTER),
            ______,       KC_M,          KC_COMMA,        KC_K,           B_SMAG,         KC_G,                                                 KC_H,       B_NRL_FARM,     KC_X,           KC_C,           KC_V,           KC_B,
            KC_Y,         KC_SCLN,       KC_GRAVE,        KC_LGUI,        KC_LALT,        ______,                                               ______,     KC_LALT,        ______,         ______,         ______,         ______,
    ...
    [BLASTER] = LAYOUT_moonlander(
            KC_ESCAPE,    ______,        ______,          ______,         ______,         ______,         ______,             ______,           ______,     ______,         ______,         ______,         ______,         ______,
            KC_TAB,       KC_I,          KC_U,            KC_UP,          KC_O,           KC_P,           KC_T,               ______,           KC_LCTL,    KC_Q,           BLASTER_SGP,    KC_E,           KC_R,           KC_T,
      LT(_F_,KC_DOT),     KC_LSFT,       KC_LEFT,         KC_DOWN,        KC_RIGHT,       KC_L,           KC_H,               ______,           KC_J,       BLASTER_A,      B_SKATE,        BLASTER_D,      KC_F,           KC_ENTER,
            B_BUNKER,     KC_M,          KC_COMMA,        KC_K,           B_SMAG,         KC_N,                                                 KC_Z,       BLASTER_M,      KC_X,           KC_C,           KC_V,           KC_B,
            KC_Y,         KC_SCLN,       KC_GRAVE,        KC_LGUI,        KC_LALT,        LT(_F_,KC_ESCAPE),                             LT(_F_,KC_ESCAPE), KC_LALT,        B_SNARL,        ______,         ______,         ______,
                                                          KC_SPACE,       KC_ENTER,       KC_DEL,                                               ______,     KC_ENTER,       KC_COMMA
            ),
